...
if($debug)
  echo "<span class=\"ctrl\"><a href=\"". substr(GetCurrentLocation(), 0, -8) ."\" class=\"menu\">nastaveni</a></span><br /><br />";
else{
  if($vari || $currentdir) $spojka = "&amp;";
  else $spojka = "?";
  echo "<span class=\"ctrl\"><a href=\"".GetCurrentLocation(). $spojka . "debug=1\" class=\"menu\">nastaveni</a></span><br /><br />";
}
...
if($debug){
  ...
  echo "<span class=\"pvy\">Uzivatelske nastaveni: </span><br />
    ...
    <a href=\"". substr(GetCurrentLocation(), 0, -8) ."\" class=\"ctrl\" style=\"color: #691f00;\">zavrit</a>
