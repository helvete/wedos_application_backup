...
// fields
'name'    => 'Jméno, Příjmení / Firma:',
'email'   => 'Kontaktní email:',
'address' => 'Adresa:',
'phone'   => 'Kontaktní telefon:',
'website' => 'Webové stránky',
'subject' => 'Předmět',
'message' => 'Pro jakou budovu se bude PENB zpracovávat?<br /> (stačí přibližné určení např. <i>bytový dům 6p.</i>)',
'file'    => 'Přílohy',
'captcha' => 'Captcha',
'reload'  => 'Načíst znovu',
...
// status messages
'sent'    => 'Dobrý den, děkujeme za Váš zájem o vypracování PENB právě u naší firmy. Náš specialista Vás bude co nejdříve, max. do 2 pracovních dní kontaktovat.',
